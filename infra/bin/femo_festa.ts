...
const api = new ApiStack(app, `FemoFesta-Api-${stage}`, { env, stage, userPool: auth.userPool, appClient: auth.appClient, leaderboardTable: dynamo.leaderboardTable, broadcastFunction: websocket.broadcastFunction });
